...
const TEST_BYPASS_PHONE = '71111111111';
...
export default function AuthScreen() {
  ...
  }, [loginWithToken, rawPhone, step, utils.phoneAuth.checkStatus]);
  ...
  const handleRequestCall = useCallback(async () => {
    ...
    if (rawPhone === TEST_BYPASS_PHONE) {
      ...
      try {
        ...
        setStep('error');
        setErrorMsg('Ошибка входа в тестовый аккаунт');
      }
      return;
    }
  ...
  }, [login, rawPhone, requestCallMutation]);
