...
import { User, Phone, LogOut, Shield, Tag, Plus, Edit2, Trash2, X, Globe, Palette, BookOpen, Download, Upload, CreditCard, Lock, QrCode, Monitor, BarChart3, Settings2, ChevronRight } from 'lucide-react-native';
    ...
    <View style={[styles.background, { backgroundColor: theme.background }]}>
      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.adminMenuContainer} testID="profile.adminMenu.container">
            ...
            <View style={styles.adminMenuButtons}>
              <TouchableOpacity
                style={styles.adminMenuButton}
                onPress={() => router.push('/admin' as any)}
                activeOpacity={0.7}
                testID="profile.adminMenu.admin"
              >
                <View style={styles.adminMenuButtonLeft}>
                  <Settings2 size={18} color={theme.primary} />
                  <Text style={styles.adminMenuButtonText}>АДМИН-ПАНЕЛЬ</Text>
                </View>
                <ChevronRight size={18} color={theme.primaryDim} />
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                testID="profile.adminMenu.analytics"
              >
                <View style={styles.adminMenuButtonLeft}>
                  <BarChart3 size={18} color={theme.primary} />
                  <Text style={styles.adminMenuButtonText}>АНАЛИТИКА</Text>
                </View>
                <ChevronRight size={18} color={theme.primaryDim} />
              </TouchableOpacity>
            </View>
